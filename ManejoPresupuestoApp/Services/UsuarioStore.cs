...
namespace ManejoPresupuestoApp.Services
{
    public class UsuarioStore : IUserStore<Usuario>, IUserEmailStore<Usuario>, IUserPasswordStore<Usuario>
    {
        ...
        {
            var usuario = await _repositorioUsuarios.BuscarUsuarioPorEmail(normalizedEmail);
            return usuario;
        }
        ...
        {
            var usuario = await _repositorioUsuarios.BuscarUsuarioPorEmail(normalizedUserName);
            return usuario;
        }
